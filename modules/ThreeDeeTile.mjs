	  ...
	  if (this.boundingVolume && this.boundingVolume.box) {
		...
		if (DEBUG) {
		  ...
		  this.debugLine = line;
			...
			let line = new THREE.LineSegments(  new THREE.EdgesGeometry(new THREE.BoxGeometry(b[3] * 2, b[7] * 2, b[11] * 2)), new THREE.LineBasicMaterial( {color: new THREE.Color(0xff0000), transparent: true, linewidth: 1, depthWrite: false, visible: true, opacity: 0.0}) );
			this.debugLine = line;
		}
	  } else {
		this.extent = null;
